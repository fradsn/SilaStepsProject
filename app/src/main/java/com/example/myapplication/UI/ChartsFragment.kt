...
import com.example.myapplication.UI.CurrentActivityFragment
...
class ChartsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val history = CurrentActivityFragment.Companion.bpmHistory
    ...
    private fun setupBarChart(chart: BarChart) {
        ...
        chart.data = BarData(BarDataSet(entries, "Minuti").apply {
            colors = activityColors; valueTextColor = Color.WHITE
        })
    ...
    private fun setupPieChart(chart: PieChart) {
        ...
        chart.data = PieData(PieDataSet(entries, "").apply {
            colors = activityColors; valueTextColor = Color.WHITE; sliceSpace = 3f
        })
        chart.description.isEnabled = false
